...
public class FlightEndpoint extends AbstractHttpEndpoint {
    ...
    public HttpResponse markAvailable(String slotId, AvailabilityRequest request) {
        ...
        componentClient
                ...
                .invoke(
                        new BookingSlotEntity.Command.MarkSlotAvailable(new Participant(request.participantId(), participantType))
                );
    ...
    public HttpResponse unmarkAvailable(String slotId, AvailabilityRequest request) {
        ...
        componentClient
                ...
                .invoke(
                        new BookingSlotEntity.Command.UnmarkSlotAvailable(new Participant(request.participantId(), participantType))
                );
